...
public class AuthControllerTest {
    ...
    public void testRegister() {
        User user = new User();
        AuthResponse expectedResponse = new AuthResponse("testToken", "User registered successfully", user.getUsername(), user.getPassword(), user.getRole(), user.getMoney(), user.getId());
